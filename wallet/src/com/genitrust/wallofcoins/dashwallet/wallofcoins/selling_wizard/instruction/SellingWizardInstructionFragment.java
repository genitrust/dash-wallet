package com.genitrust.wallofcoins.dashwallet.wallofcoins.selling_wizard.instruction;
...
public class SellingWizardInstructionFragment extends SellingWizardBaseFragment implements View.OnClickListener {
    ...
    private TextView text_cancle, text_save, text_edit_current_rate, text_bank_name,
            text_holder_name, text_acc_number, text_coin_avail,
    ...
    private void init() {
        ...
        text_coin_avail = (TextView) rootView.findViewById(R.id.text_coin_avail);
