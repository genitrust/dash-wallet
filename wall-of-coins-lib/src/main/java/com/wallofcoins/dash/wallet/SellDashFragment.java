...
import de.schildbach.wallet.AddressBookProviderHelper;
import de.schildbach.wallet.Configuration;
import de.schildbach.wallet.ConfigurationProvider;

import com.wallofcoins.dash.wallet.api.WallofCoins;
import com.wallofcoins.dash.wallet.databinding.ItemAdsListingBinding;
import com.wallofcoins.dash.wallet.databinding.SellDashFragmentBinding;
import com.wallofcoins.dash.wallet.request.CreateAuthReq;
import com.wallofcoins.dash.wallet.response.AdsListActivityResp;
...
import com.wallofcoins.dash.wallet.response.CreateAdResp;
import com.wallofcoins.dash.wallet.response.CreateAuthErrorResp;
import com.wallofcoins.dash.wallet.response.CreateAuthResp;
import com.wallofcoins.dash.wallet.response.GetAuthTokenResp;
import com.wallofcoins.dash.wallet.response.GetCurrencyResp;
import com.wallofcoins.dash.wallet.response.GetPricingOptionsResp;
...
//    private WalletApplication application;
    ...
    public void onAttach(final Context context) {
        ...
        this.config = ((ConfigurationProvider)getActivity().getApplication()).getConfiguration();

        this.loaderManager = getLoaderManager();
        LocalBroadcastHelper.WalletBalanceBroadcast.registerResponseReceiver(getActivity(), mWalletBalanceReceiver);
    }

    @Override
    public void onDetach() {
        LocalBroadcastHelper.WalletBalanceBroadcast.unregisterReceiver(getActivity(), mWalletBalanceReceiver);
        super.onDetach();
    }

    private BroadcastReceiver mWalletBalanceReceiver = new BroadcastReceiver() {
        @Override
        public void onReceive(Context context, Intent intent) {
            balance = (Coin) LocalBroadcastHelper.WalletBalanceBroadcast.extractBalance(intent);
            updateView();
        }
    };
                ...
                public void onResponse(Call<VerifyAdResp> call, Response<VerifyAdResp> response) {
                    if (null != response && null != response.body()) {
                        ...
                        if (null != verifyAdResp.fundingAddress) {
                            ...
                            mNewValues.put(AddressBookProviderHelper.KEY_ADDRESS, verifyAdResp.fundingAddress);
...
//    }
    ...
    private void updateView() {
        LocalBroadcastHelper.WalletBalanceBroadcast.sendRequestBroadcast(getActivity());
    }
