package com.genitrust.wallofcoins.dashwallet.wallofcoins.selling_wizard;
...
import com.genitrust.wallofcoins.dashwallet.wallofcoins.selling_wizard.selling_home.SellingWizardHomeFragment;
...
public class SellingWizardBaseActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        init();
        setListners();
        replaceFragment(new SellingWizardHomeFragment(), false, false);
    }
    ...
    public void removeAllFragmentFromStack() {
        ...
        if (fragmentManager.getBackStackEntryCount() > 0) {
            SellingWizardFragmentUtils.sDisableFragmentAnimations = true;
            fragmentManager.popBackStackImmediate(null, FragmentManager.POP_BACK_STACK_INCLUSIVE);
            SellingWizardFragmentUtils.sDisableFragmentAnimations = false;
        }
    }
}
