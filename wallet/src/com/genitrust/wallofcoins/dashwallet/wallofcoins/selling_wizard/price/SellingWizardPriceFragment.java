package com.genitrust.wallofcoins.dashwallet.wallofcoins.selling_wizard.price;
...
import com.genitrust.wallofcoins.dashwallet.wallofcoins.selling_wizard.advanced_options.SellingWizardAdvanceOptionsFragment;
...
import com.genitrust.wallofcoins.dashwallet.wallofcoins.selling_wizard.models.SellingWizardMarketsVo;
...
public class SellingWizardPriceFragment extends SellingWizardBaseFragment implements View.OnClickListener {
    ...
    private void getMarkes() {
        if (NetworkUtil.isOnline(mContext)) {
            SellingAPIClient.createService(mContext).getMarkets(SellingApiConstants.CRYPTO, "USD").enqueue(new Callback<ArrayList<SellingWizardMarketsVo>>() {
                @Override
