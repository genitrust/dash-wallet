package com.genitrust.wallofcoins.dashwallet.wallofcoins.buying_wizard.email_phone;
...
import com.genitrust.wallofcoins.dashwallet.wallofcoins.CustomAdapter;
...
import com.genitrust.wallofcoins.dashwallet.wallofcoins.buying_wizard.utils.BuyingWizardPhoneListPref;
                                ...
                                if (!TextUtils.isEmpty(password) && TextUtils.isEmpty(((BuyingWizardBaseActivity) mContext)
                                    ...
                                    if (fromScreen.equalsIgnoreCase("PhoneListFragment"))
                                        ((BuyingWizardBaseActivity) mContext)
                                                .popBackAllFragmentsExcept("com.genitrust.wallofcoins.dashwallet.wallofcoins.buying_wizard.phone_list.PhoneListFragment");
                                    else
                                        createHold();
                                }
                            }
