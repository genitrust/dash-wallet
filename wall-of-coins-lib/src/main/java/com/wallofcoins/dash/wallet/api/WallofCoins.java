...
public class WallofCoins {
    ...
    public static RestApi createService(Interceptor interceptor, Context context) {
        API_BASE_URL = "https://wallofcoins.com/";//context.getString(R.string.base_url);
